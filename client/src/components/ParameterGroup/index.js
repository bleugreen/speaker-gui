...
const ParameterGroup = ({theme, pattern, layer, setters}) => {
    switch(pattern){
        case 'rain':
            return <RainParams theme={theme} layer={layer} setters={setters}/>
        case 'lingradient':
            return <LinGradientParams theme={theme} layer={layer} setters={setters}/>
        case 'general':
            return <GeneralParams theme={theme} layer={layer} setters={setters}/>
        case 'twinkle':
            return <TwinkleParams theme={theme} layer={layer} setters={setters}/>
        default:
            return <div></div>
    }
}
